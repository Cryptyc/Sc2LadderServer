...
public:
    ...
    static bool ProcessObservationResponse(SC2APIProtocol::ResponseObservation Response,
...
private:
    ...
    std::string
    GetBotCommandLine(const BotConfig &AgentConfig, int GamePort, int StartPort, const std::string &OpponentId,
                      bool CompOpp = false, sc2::Race CompRace = sc2::Race::Terran,
                      sc2::Difficulty CompDifficulty = sc2::Difficulty::Easy);

    ResultType GetPlayerResults(sc2::Connection *client);

    GameResult StartGameVsDefault(const BotConfig &Agent1, sc2::Race CompRace, sc2::Difficulty CompDifficulty,
